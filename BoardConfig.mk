...
ifeq ($(USE_GLOBAL_VENDOR),true)
    BOARD_PREBUILT_ODMIMAGE := $(CHOPIN_PREBUILT)/odm_global.img
    BOARD_PREBUILT_VENDORIMAGE := $(CHOPIN_PREBUILT)/vendor_global.img
else
...
BOARD_CHOPIN_DYNAMIC_PARTITIONS_SIZE := 9122611200
